...
import com.example.foro.Usuarios.UsuarioRepository;
import com.example.foro.validacion.CrudTopicoService;
import com.example.foro.validacion.DatosActualizarTopico;
import com.example.foro.validacion.DatosCrearTopico;
import com.example.foro.validacion.DatosListadoTopico;
import com.example.foro.validacion.DatosRespuestaTopico;
import com.example.foro.validacion.Topico;
import com.example.foro.validacion.TopicoRepository;
...
public class TemaControlador {
    ...
    public ResponseEntity actualizarTopico(@RequestBody @Valid DatosActualizarTopico datosActualizarTopico) {
        topicoRepository.getReferenceById(datosActualizarTopico.id());
        boolean topico = true;
        if (!topico) {
